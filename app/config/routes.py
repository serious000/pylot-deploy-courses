...
routes['GET']['/courses/remove/<int:remove_id>'] = 'Courses#remove'
routes['POST']['/courses/remove_one_id/<int:remove_id>'] = 'Courses#remove_one_id'
routes['GET']['/courses/no'] = 'Courses#no'
